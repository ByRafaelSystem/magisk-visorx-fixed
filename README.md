...
<img src="webroot/banner_vx9.png" alt="VisorX Banner" width="600"/>
...
5. Abrí la WebUI → elegí tu perfil
...
5. Open WebUI → choose your profile
...
3. Instale pelo ZIP
4. Reinicie
5. Abra o WebUI → escolha o perfil
...
5. Откройте WebUI → выберите профиль
